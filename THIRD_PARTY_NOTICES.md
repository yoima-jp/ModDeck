...
The PNG icon textures under `assets/moddeck/textures/gui/icons/` are rasterized copies of the
packaged Lucide SVG sources because Minecraft Java Edition does not decode SVG textures at runtime.
