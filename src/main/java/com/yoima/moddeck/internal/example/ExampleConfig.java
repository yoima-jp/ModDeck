...
public final class ExampleConfig {
    ...
    public static void register() {
        ...
        FloatOption scale = new FloatOption("scale", key("option.scale"), key("option.scale.desc"),
                1.0f, 0.5f, 2.0f, 0.1f);
        scale.formatWith(value -> ConfigText.literal(String.format(java.util.Locale.ROOT, "%.1f", value)));
        ...
        ConfigScreenApi.register(ConfigDefinition.builder("example_mod")
                ...
                .addOption(new KeybindOption("action_key", key("option.key"), key("option.key.desc"),
                        "key.keyboard.g", Set.of(KeybindOption.InputType.KEYBOARD,
